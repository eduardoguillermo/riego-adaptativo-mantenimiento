/* drive-sync.js — v1.0.0
   ...
   Control Financiero, Riego Adaptativo). Soporta múltiples archivos con nombre
...
const DriveSync = (() => {
  ...
  const CARPETA = 'RiegoAdaptativoMantenimiento';
  const TOKEN_KEY = 'riego_mant_drive_token';
